function [maxCorr,ming_dist,Rcoor,gdistcoor] = runjob_l1_I_FC(subj,wstdn,flagsin)

% L1 pentalty with I-FC matrix replacing functional time series and *binarized

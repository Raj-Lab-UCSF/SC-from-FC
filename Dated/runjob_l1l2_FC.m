function [maxCorr,ming_dist] = runjob_l1l2_FC( subj , wstdn , flagsin )

%runjob

%
% Here we estimate SC from from L1L2 MM of fMRI time series and corresponding FC. 
% No SC involved in this version.
%
%
%
%
...
FCnetworks = ['/Users/farrasabdelnour/Documents/Research/WCMC/Projects/NYUEpilepsyMtx/FunImgARWSDFC_AALTC_' group];

tt = load('/Users/farrasabdelnour/Documents/Research/WCMC/Projects/NYUEpilepsyMtx/FunImgARWSDFC_AALTC_Ctrl/NC024_Mtx_FiltCov_FC.mat')


FCdir = dir([FCnetworks filesep '*']);
...
for ii = 1:length(a)
    for jj = 1:length(b)
        for kk = 1:length(c)
            ...
            [wk, stat] = MM_gl_l2l1_FC(FC, a(ii), b(jj),c(kk),w_0,thresh,nSamples);

function [maxCorr,ming_dist] = runjob_l1(subj , meanSC)

%runjob
%
% Estimate SC from FC with L1 penalty and *binarized* SC.
% 
% wstdn determines noise added to zero elements of binarized SC
%
...
%% Binarize SC here with noise added to zero elements
%idxrnd = double(w == 0);
...
axis square;
axis off
saveas(gcf , [saveFigs filesep 'SC_est_L1_meanSC_subj' num2str(subj)] , 'jpg');
